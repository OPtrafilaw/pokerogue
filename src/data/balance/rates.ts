...
export const GACHA_DEFAULT_COMMON_EGG_THRESHOLD = 1; // Default 204/256 chance, 203/256 chance in Legendary Up Gacha
export const GACHA_DEFAULT_RARE_EGG_THRESHOLD = 33333; // Default 44/256 chance
export const GACHA_DEFAULT_EPIC_EGG_THRESHOLD = 33333; // Default 7/256 chance, leaving Legendary as 1/256 chance
export const GACHA_LEGENDARY_UP_THRESHOLD_OFFSET = 33333; // The offset to threshold for Legendary Up gacha eggs. +x/256 Legendary Egg chance, -x/256 Common Egg chance
